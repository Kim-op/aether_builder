...
import com.aetherbuilder.nocode.ai.AiCodeGenTypeRoutingService;
import com.aetherbuilder.nocode.ai.AiCodeGenTypeRoutingServiceFactory;
...
import com.aetherbuilder.nocode.core.handler.StreamHandlerExecutor;
...
//                });
    ...
    /**
     * 删除应用时关联删除对话历史-重写删除方法
     * 注意：这里的删除逻辑是先删除对话历史，再删除应用，确保数据的完整性。
     *
     * @param id 应用ID
     * @return 是否成功
     */
